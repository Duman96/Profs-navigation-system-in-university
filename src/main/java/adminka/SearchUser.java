...
public class SearchUser extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            String sql = "SELECT * FROM users WHERE user_name='" + searchy + "' OR user_surname='" + searchy + "' OR user_nickname='" + searchy
                    + "' OR user_name LIKE '"+searchy+"%' OR user_surname LIKE '"+searchy+"%'";
